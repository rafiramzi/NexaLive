    ...
    >
      ...
      <div className="relative w-full max-w-[400px]">
        ...
        <p className="text-center text-[11px] text-zinc-700 mt-6">
          © 2025 NexaLive · <a href="/privacy" className="hover:text-zinc-500 transition-colors">Privasi</a> · <a href="/terms" className="hover:text-zinc-500 transition-colors">Syarat</a>
        </p>
      </div>
    </div>
  );
